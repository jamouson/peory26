...
export default function Hero() {
  return (
    ...
    >
      ...
      >
       Our organic, buttercream floral cakes blend exquisite taste and stunning artistry, creating unforgettable centerpieces that bring your wedding dreams to life.
      </p>
      <div
