// =============================================================================
// File: src/app/(landing)/cupcakes/cupcake-collections.tsx
// Description: Horizontal carousel of yearly cupcake collections using Embla.
...
function CollectionCard({
  ...
  return (
    <Link
      href={`/cupcakes/collections/${year}`}
...
export function CupcakeCollections() {
