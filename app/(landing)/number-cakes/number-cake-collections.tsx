// =============================================================================
// File: src/app/(landing)/number-cakes/number-cake-collections.tsx
// Description: Horizontal carousel of yearly number cake collections using Embla.
...
function CollectionCard({
  ...
  return (
    <Link
      href={`/number-cakes/collections/${year}`}
...
export function NumberCakeCollections() {
      ...
      <section className="pt-20 sm:pt-24 pb-8 sm:pb-12 overflow-hidden bg-transparent">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 mb-10 sm:mb-14">
          <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-5xl">
            Memorable Cakes for Every Occasion
          </h2>
          <p className="mt-4 max-w-2xl text-lg text-muted-foreground">
            From intimate family gatherings to grand celebrations, our number
            cakes are designed to be the centerpiece of your event, adding a
            touch of sweetness to your special moments.
          </p>
        </div>
