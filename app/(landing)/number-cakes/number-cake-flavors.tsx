// =============================================================================
// File: src/app/(landing)/number-cakes/number-cake-flavors.tsx
// Description: RTL-scrolling horizontal carousel of number cake flavors using Embla.
...
export function NumberCakeFlavors() {
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 mb-10 sm:mb-14">
          <div className="text-right">
            ...
            <p className="ml-auto mt-4 max-w-2xl text-lg text-muted-foreground">
              Our number cakes offer classic and unique flavors, made with premium
              ingredients.
            </p>
          </div>
        </div>
