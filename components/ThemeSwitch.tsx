    ...
    >
      <div
        className={cx(
          ...
          "bg-transparent",
          // checked
          "group-data-[state=checked]:bg-brand-50 group-data-[state=checked]:text-brand-600 dark:group-data-[state=checked]:bg-brand-500/20 dark:group-data-[state=checked]:text-brand-300",
          // focus
          focusRing,
        )}
      >
