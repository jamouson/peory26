...
const switchVariants = tv({
  slots: {
    root: [
      ...
      // checked
      "data-[state=checked]:bg-brand-500 data-[state=checked]:dark:bg-brand-500",
      // disabled
      "data-[disabled]:cursor-default",
      // disabled checked
      "data-[disabled]:data-[state=checked]:bg-brand-200",
      "data-[disabled]:data-[state=checked]:ring-gray-300",
      // disabled checked dark
      "data-[disabled]:data-[state=checked]:dark:ring-gray-900",
      "data-[disabled]:data-[state=checked]:dark:bg-brand-900",
      // disabled unchecked
