    ...
    >
      ...
      <dl className="mt-24 grid grid-cols-4 gap-10">
        {features.map((item) => (
          ...
          >
            <div className="w-fit rounded-lg p-2 shadow-md shadow-brand-400/30 ring-1 ring-black/5 dark:shadow-brand-600/30 dark:ring-white/5">
              <item.icon
                aria-hidden="true"
                className="size-6 text-brand-600 dark:text-brand-400"
              />
            </div>
